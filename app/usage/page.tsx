...
// Lazy load do componente de gráfico pesado
...
export default function UsagePage() {
  ...
  if (loading) {
    return (
      <AppLayout>
        <PageHeader title="Uso de Créditos" description="Acompanhe sua utilização mensal de questões" />
        ...
        <CardContent>
          ...
          {isOverLimit && (
            <p className="text-sm text-red-600 mt-2 flex items-center gap-1">
              ...
              <Button variant="link" className="p-0 h-auto text-red-600 underline" onClick={() => router.push('/plan')}>
                Fazer upgrade
              </Button>
            </p>
          )}
