  ...
  return (
    <AppLayout>
      <PageHeader
        ...
        description="Gere questões personalizadas automaticamente com inteligência artificial"
      />
      ...
      <Card className="overflow-visible">
        <CardHeader>
          ...
          <CardDescription>Preencha os campos abaixo para gerar questões personalizadas</CardDescription>
        </CardHeader>
        <CardContent>
