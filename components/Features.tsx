            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p className="text-xl text-muted-foreground">
                        Nossa plataforma combina inteligência artificial de última geração com uma interface intuitiva
                        para revolucionar sua experiência de criação de provas.
                    </p>
                </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-lg text-muted-foreground mb-8">
                                Professores que usam ProvaFácil AI relatam uma transformação completa em sua rotina de
                                trabalho, com mais tempo para se dedicar ao ensino.
                            </p>
