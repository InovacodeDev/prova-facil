...
import { Zap, Brain, FileText, Upload, BarChart3, Shield, Clock, Sparkles, CheckCircle, Copy } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-foreground mb-6">
            ...
            <span className="bg-gradient-primary bg-clip-text text-transparent">avaliações perfeitas</span>
          </h2>
          <p className="text-xl text-muted-foreground">
            Nossa plataforma combina inteligência artificial de última geração com uma interface intuitiva para
            revolucionar sua experiência de criação de provas.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="p-6 hover:shadow-lg transition-all duration-smooth hover:scale-105 border-border"
            >
        ...
        <div className="bg-card rounded-2xl p-8 lg:p-12 border border-border">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h3 className="text-2xl lg:text-3xl font-bold text-foreground mb-6">Transforme sua rotina pedagógica</h3>
              <p className="text-lg text-muted-foreground mb-8">
                Professores que usam ProvaFácil AI relatam uma transformação completa em sua rotina de trabalho, com
                mais tempo para se dedicar ao ensino.
              </p>
            ...
            <div className="relative">
              <div className="bg-gradient-hero rounded-xl p-8 text-white">
                <div className="space-y-6">
                  ...
                  <div className="text-lg opacity-90">Redução no tempo de preparação de avaliações</div>
