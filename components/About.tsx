      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground mb-6">
            Nascemos da necessidade de simplificar o processo de criação de avaliações para educadores. Nossa missão é
            empoderar professores com tecnologia de ponta, permitindo que se concentrem no que realmente importa:
            ensinar.
          </p>
