          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl lg:text-6xl font-bold text-foreground leading-tight">
                Crie provas em <span className="bg-gradient-primary bg-clip-text text-transparent">segundos</span>, não
                horas
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="outline" size="lg" className="text-base" onClick={() => router.push('/support')}>
                Ver Demonstração
              </Button>
            </div>
            ...
            <div className="pt-8 border-t border-border space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  <p className="text-2xl font-bold text-primary">{usersCount > 0 ? formatNumber(usersCount) : '---'}</p>
