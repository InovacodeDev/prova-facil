        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-end md:items-center justify-center p-4">
            <Card className="w-full max-w-2xl shadow-2xl">
                <CardHeader>
                    ...
                    <CardDescription>
                        Utilizamos cookies para melhorar sua experiência. Cookies essenciais são obrigatórios para o
                    ...
                    {!showDetails ? (
                        <div className="space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Respeitamos sua privacidade. Você pode escolher quais cookies deseja aceitar. Para mais
                            ...
                            <div className="flex items-center justify-between space-x-2">
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-muted-foreground mt-1">
                                        Necessários para autenticação, segurança e funcionalidades básicas. Não podem
                                        ser desativados.
                                    </p>
                                </div>
